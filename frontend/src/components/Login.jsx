...
export default function Login() {
	return (
		...
		<div className="flex flex-col justify-center items-center h-full">
		  <form action="" className="max-w-[480px] rounded-xl shadow-lg shadow-black p-8 w-full mx-auto bg-white">
			...
			<button className="w-full py-3 my-4 rounded bg-blue-500 hover:bg-blue-400 relative text-white">
  			...
  			<h5 className="text-center font-bold cursor-pointer">Not a member? Sign-up Now</h5>
		  </form>
		</div>
	  </div>  
	)
